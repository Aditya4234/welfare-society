      ...
      <div className="mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8">
        <div className="grid items-center gap-12 lg:grid-cols-2">
          ...
          <div className="animate-fade-in-up">
            <div className="inline-flex items-center gap-2 rounded-full border border-brand-900/10 bg-white/75 dark:bg-slate-800/75 px-5 py-2 text-xs font-semibold uppercase tracking-wider text-slate-700 dark:text-slate-300 mb-6 backdrop-blur-sm">
